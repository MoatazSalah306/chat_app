             ...
             <x-dropdown align="right" width="48">
                ...
                <x-slot name="content">
                    ...
                    <div class="w-full p-1" x-data="{ sortOrder: @entangle('sortOrder') }">
                        ...
                        <a @click.prevent="$wire.setSortOrder('desc')" @class(['cursor-pointer items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 text-gray-500 hover:bg-gray-100 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-100', 'bg-gray-100' => $sortOrder == 'desc'])>
                        ...
                        <a @click.prevent="$wire.setSortOrder('asc')" @class(['cursor-pointer items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 text-gray-500 hover:bg-gray-100 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-100', 'bg-gray-100' => $sortOrder == 'asc'])>
                        ...
                        <aside class="grid grid-cols-12 w-full">
                            ...
                            <a wire:navigate href={{route('chat',$conversation->id)}} class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                                ...
                                <div class="flex justify-between w-full items-center">
                                    ...
                                    <small class="text-gray-700 dark:text-gray-500">{{$conversation->messages?->last()?->created_at?->shortAbsoluteDiffForHumans()}} </small>
                                ...
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical ml-2 w-5 h-5 text-gray-700" viewBox="0 0 16 16">
