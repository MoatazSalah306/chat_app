        ...
        <ul class="p-2 grid w-full spacey-y-2">
            ...
            <li
                ...
                <aside class="grid grid-cols-12 w-full">
                    ...
                    <a class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                        ...
                        <div class="flex justify-between w-full items-center">
                            ...
                            <small class="text-gray-700 dark:text-gray-500">2 days ago</small>
